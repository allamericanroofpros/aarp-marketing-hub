...
const navItems = [
  ...
  { label: 'Video Analytics', path: '/video-analytics', icon: PlayCircle },
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className={cn(
          ...
          <div className="p-3 border-b border-sidebar-border">
            {!f.tvMode ? (
              <>
                <h1 className="text-[10px] font-bold text-sidebar-primary tracking-widest">AARP MARKETING OS</h1>
                <p className="text-[9px] text-sidebar-foreground/50 mt-0.5">All American Roof Pros</p>
              </>
            ) : (
